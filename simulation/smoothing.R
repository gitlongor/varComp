...
(fit1.cs=varComp(y1~x, varcov=list(K.cs), control=list(start=1e-3)))
(fit1.cs=varComp(y1~x, varcov=list(K.cs), control=list(start=1e3)))
(fit1.co=varComp(y1~x, varcov=list(K.co), control=list(start=1e-3)))
(fit1.co=varComp(y1~x, varcov=list(K.co), control=list(start=1e3)))

(fit3.cs=varComp(y3~x, varcov=list(K.cs), control=list(start=1e-3)))
(fit3.cs=varComp(y3~x, varcov=list(K.cs), control=list(start=1e3)))
(fit3.co=varComp(y3~x, varcov=list(K.co), control=list(start=1e-3)))
(fit3.co=varComp(y3~x, varcov=list(K.co), control=list(start=1e3, plot.it=T)))

(fit3.cs=varComp(y3~x, varcov=list(K.cs), control=list(start=1e-3)))
(fit3.cs=varComp(y3~x, varcov=list(K.cs), control=list(start=1e3)))
(fit3.co=varComp(y3~x, varcov=list(K.co), control=list(start=1e-3)))
(fit3.co=varComp(y3~x, varcov=list(K.co), control=list(start=1e4, plot.it=T)))


(fit4.cs=varComp(y4~x, varcov=list(K.cs), control=list(start=1e-3)))
(fit4.cs=varComp(y4~x, varcov=list(K.cs), control=list(start=1e3)))
(fit4.co=varComp(y4~x, varcov=list(K.co), control=list(start=1e-3)))
(fit4.co=varComp(y4~x, varcov=list(K.co), control=list(start=1e4, plot.it=T)))
